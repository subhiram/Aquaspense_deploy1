"""
Django settings for cheuvu1 project.
...
SECRET_KEY = 'django-insecure-%#$nhxlbk4u6@oj%wm$6vvu&3pc8sa+$o@y-^q*$r61g2#+20('
...
WSGI_APPLICATION = 'cheuvu1.wsgi.application'
